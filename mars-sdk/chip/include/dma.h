...
// HW LLP (Linked list multi-block) is supported on MARS...
#define SUPPORT_HW_LLP  1 //0 // TODO: change to 1 since Linked list is supported!
...
#define DMA_CH_EN_PIPO          (0x1 << 2) // enable PingPong transfer
...
extern bool dma_channel_check_select(uint8_t ch, uint8_t xfer_type, uint8_t hs_id);
