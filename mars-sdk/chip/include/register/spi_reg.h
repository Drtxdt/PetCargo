//  ----------------------------------------------------------------------
//  File Name   : GenCFold/spi_reg_mars.h
...
#define SPI_SLVDATACNT_OFFSET                       0x064
#define SPI_SLVDATACNT_WCNT_Pos                     16
#define SPI_SLVDATACNT_WCNT_Msk                     0x1ff0000
#define SPI_SLVDATACNT_RCNT_Pos                     0
#define SPI_SLVDATACNT_RCNT_Msk                     0x1ff
...
struct SPI_REG_SLVDATACNT_BITS
{
    volatile uint32_t RCNT                          : 9; // bit 0~8
    volatile uint32_t RESV_9_15                     : 7; // bit 9~15
    volatile uint32_t WCNT                          : 9; // bit 16~24
    volatile uint32_t RESV_25_31                    : 7; // bit 25~31
};

union SPI_REG_SLVDATACNT {
    volatile uint32_t                               all;
    struct SPI_REG_SLVDATACNT_BITS                  bit;
};
...
typedef struct
{
    ...
    union SPI_REG_SLVDATACNT                        REG_SLVDATACNT; // 0x064
