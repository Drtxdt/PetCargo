...
del /q build_keil\main.obj build_keil\PetCargo_Main_Keil build_keil\PetCargo_Main_Keil.hex build_keil\PETCARGO_MAIN_KEIL.M51 2>nul
echo [CC] PetCargo main board
...
echo [LD] PetCargo main board + STCBSP_V3.6.LIB
"%KEIL_BIN%\BL51.exe" "build_keil\main.obj, ..\vendor\STCBSP_V3.6.LIB" TO "build_keil\PetCargo_Main_Keil" > build_keil\link.log
if not exist build_keil\PetCargo_Main_Keil type build_keil\link.log& exit /b 1
"%KEIL_BIN%\OH51.exe" build_keil\PetCargo_Main_Keil > build_keil\hex.log
if not exist build_keil\PetCargo_Main_Keil.hex type build_keil\hex.log& exit /b 1
echo [OK] %CD%\build_keil\PetCargo_Main_Keil.hex
exit /b 0
